...
// Velvet Blood-to-Ash Luxury Palette
// Top: "show almost not even red, it show off blood to the top, to the very top. It mix properly."
val VelvetOffBloodTop = Color(0xFF63101C)
...
val VelvetDarkBurgundy = Color(0xFF380718)
val VelvetDeepCrimson = Color(0xFF880E2F)
val VelvetWine = Color(0xFF5E0B24)
val VelvetMutedPurple = Color(0xFF4A1535)
val VelvetActiveGlow = Color(0x4DE5284D)
val VelvetActivePill = Color(0xFFE5284D)

// Surfaces & Overlays
val VelvetPureBlack = Color(0xFF0D0F13)
val VelvetObsidian = Color(0xFF14171D)
val VelvetSurface = Color(0xFF1B1E24)
val VelvetSurfaceElevated = Color(0xFF282C34)
val VelvetSurfaceGlass = Color(0x80262931)

// Typography & Icon colors
val VelvetTextPrimary = Color(0xFFF5F6F8)
